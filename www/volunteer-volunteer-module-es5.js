(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["volunteer-volunteer-module"], {
    ...
    function LDQ(module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_exports__["default"] = ".active-volunteer-tab {\n  color: #e8604c;\n}\n\n.how_food {\n  text-align: right;\n  margin-top: -9px;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
      /***/
    },
    ...
    function dNb(module, __webpack_exports__, __webpack_require__) {
      ...
      var VolunteerPage = /*#__PURE__*/function () {
        ...
        return _createClass(VolunteerPage, [{
          key: "ngOnInit",
        ...
        return _createClass(CaptchaComponent, [{
          ...
          value: function ngOnInit() {
            ...
            this.NotificationCount.data$.subscribe(function (newData) {
              _this10.notificationCount = newData;
            });
            ...
            this.fetch.get_notification(this.model.user_id).subscribe(function (res) {
              _this10.notification = res['data'];
              _this10.notifications_admin = res['notifications'];

              if (_this10.notification.length != 0 || _this10.notifications_admin.length != 0) {
                $('#black_spot').show();
                var notifCount = _this10.notification.length + _this10.notifications_admin.length;

                _this10.NotificationCount.updateData(notifCount);
              }
            });
          }
        }, {
