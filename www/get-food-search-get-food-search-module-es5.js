(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["get-food-search-get-food-search-module"], {
    ...
    function OYR2(module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_exports__["default"] = ".receiver_food_type-error-text {\n  color: red;\n  display: none;\n}\n\n.number-error-text {\n  color: red;\n  display: none;\n}\n\n.distance-error-text {\n  color: red;\n  display: none;\n}\n\n.error-line {\n  border: 1px solid red;\n}\n\n.error-minus {\n  border-left: 1px solid red;\n  border-top: 1px solid red;\n  border-bottom: 1px solid red;\n}\n\n.error-minus {\n  border-right: 1px solid red;\n  border-top: 1px solid red;\n  border-bottom: 1px solid red;\n}\n\n.error-value {\n  border-top: 1px solid red;\n  border-bottom: 1px solid red;\n}\n\n.star {\n  color: red;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
      /***/
    },
    ...
    function jzTr(module, __webpack_exports__, __webpack_require__) {
      ...
      var GetFoodSearchPage = /*#__PURE__*/function () {
        ...
        return _createClass(GetFoodSearchPage, [{
          key: "ngOnInit",
          value: function ngOnInit() {}
        }, {
          key: "presentAlert",
                    ...
                    return this.alertController.create({
                      ...
                      buttons: [{
                        ...
                        handler: function handler() {
                          _this5.diagnostic.switchToLocationSettings();
                        }
                      }]
                    });
          ...
          value: function ionViewWillEnter() {
            ...
            if (this.location_data) {
              ...
              this.fetch.recomended_distance(data).subscribe(function (res) {
                _this6.model.recommended_distance = res.data;
              });
            }
            ...
            this.geolocation.getCurrentPosition(this.options).then(function (resp) {
              ...
              _this6.model.currLat = resp.coords.latitude;
              _this6.model.currLng = resp.coords.longitude;
              var self = _this6;
              localStorage.setItem('nearby_lat', self.model.currLat);
              localStorage.setItem('nearby_lng', self.model.currLng);
              self.nativeGeocoder.reverseGeocode(resp.coords.latitude, resp.coords.longitude, _this6.geoencoderOptions).then(function (result) {
                self.model.curr_address = self.generateAddress(result[0]);
                localStorage.setItem('nearby_address', _this6.model.curr_address);
              })["catch"](function (error) {});
            });
                  ...
                  case 3:
                    ...
                    modal.onDidDismiss().then(function (dataReturned) {
                      if (dataReturned !== null) {
                        ...
                        if (_this7.dataReturned.length > 0) {
                          _this7.ontheway_data = _this7.dataReturned;
                          _this7.location_data = null;
                        }
                      }
                    });
                    _context4.next = 7;
                    ...
                    modal.onDidDismiss().then(function (dataReturned) {
                      if (dataReturned !== null) {
                        ...
                        if (dataReturned.data != 'accept') {
                          ...
                          if (_this8.location_data != null) {
                            _this8.router.navigate(['/get-food-nearest-donors', JSON.stringify(_this8.data), _this8.location_data.latitude, _this8.location_data.longitude, _this8.model.user_id, receiver_food_id]);
                          } else if (_this8.ontheway_data.length > 0) {
                            _this8.router.navigate(['/get-food-nearest-donors', JSON.stringify(_this8.data), _this8.ontheway_data[0].startLat, _this8.ontheway_data[0].startLng, _this8.model.user_id, receiver_food_id]);
                          }
                        }
                      }
                    });
              ...
              return _regeneratorRuntime().wrap(function _callee6$(_context6) {
                while (1) switch (_context6.prev = _context6.next) {
                  ...
                  case 2:
                    ...
                    modal.onDidDismiss().then(function (dataReturned) {
                      if (dataReturned !== null) {
                        _this9.dataReturned = dataReturned.data; //alert('Modal Sent Data :'+ dataReturned);
                      }
                    });
                    _context6.next = 6;
                    return modal.present();
