(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["choose-donate-option-choose-donate-option-module"], {
    ...
    function Saw6(module, __webpack_exports__, __webpack_require__) {
      ...
      var ChooseDonateOptionPageModule = /*#__PURE__*/_createClass(function ChooseDonateOptionPageModule() {
      ...
      ChooseDonateOptionPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        ...
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"], _choose_donate_option_routing_module__WEBPACK_IMPORTED_MODULE_5__["ChooseDonateOptionPageRoutingModule"], _footer_footer_module__WEBPACK_IMPORTED_MODULE_8__["FooterPageModule"]]
    ...
    function dACR(module, __webpack_exports__, __webpack_require__) {
      ...
      var ChooseDonateOptionPage = /*#__PURE__*/function () {
        ...
        return _createClass(ChooseDonateOptionPage, [{
          key: "ngOnInit",
          value: function ngOnInit() {}
        }, {
                  ...
                  case 3:
                    ...
                    modal.onDidDismiss().then(function (dataReturned) {
                      if (dataReturned !== null) {
                        ...
                        _this3.donate_address = _this3.dataReturned;
                        var formData = new FormData();
                        formData.append("id", _this3.model.veg);
                        formData.append("id2", _this3.model.nonveg);
                        formData.append("donate_address", _this3.donate_address);

                        _this3.fetch.test(formData).subscribe(function (res) {
                          if (res['success'] == true) {
                            if (res['data'].length > 0) {
                              _this3.router.navigate(['/searching-volunteer', _this3.model.veg, _this3.model.nonveg]);
                            } else {
                              _this3.showAlert(_this3.model.key_text3);

                              _this3.router.navigate(['/screen-after-volunteer-not-found', _this3.model.veg, _this3.model.nonveg]);
                            }
                          }
                        });
                      }
    ...
    function glUc(module, __webpack_exports__, __webpack_require__) {
      ...
      var ChooseDonateOptionPageRoutingModule = /*#__PURE__*/_createClass(function ChooseDonateOptionPageRoutingModule() {
