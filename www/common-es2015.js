...
let TermsConditionsPage = class TermsConditionsPage {
    constructor(modalController, navParams, storage, router, fetch) {
        this.modalController = modalController;
        this.navParams = navParams;
        this.storage = storage;
        this.router = router;
