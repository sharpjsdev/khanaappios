(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["donate-food-pickup-drop-donate-food-pickup-drop-module"], {
    ...
    function gwJ(module, __webpack_exports__, __webpack_require__) {
      ...
      var DonateFoodPickupDropPageRoutingModule = /*#__PURE__*/_createClass(function DonateFoodPickupDropPageRoutingModule() {
    ...
    function KDMT(module, __webpack_exports__, __webpack_require__) {
      ...
      var DonateFoodPickupDropPageModule = /*#__PURE__*/_createClass(function DonateFoodPickupDropPageModule() {
      ...
      DonateFoodPickupDropPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        ...
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"], _donate_food_pickup_drop_routing_module__WEBPACK_IMPORTED_MODULE_5__["DonateFoodPickupDropPageRoutingModule"], _footer_footer_module__WEBPACK_IMPORTED_MODULE_8__["FooterPageModule"]]
    ...
    function PxVs(module, __webpack_exports__, __webpack_require__) {
      ...
      var DonateFoodPickupDropPage = /*#__PURE__*/function () {
        ...
        return _createClass(DonateFoodPickupDropPage, [{
          key: "ngOnInit",
          value: function ngOnInit() {}
        }, {
          ...
          value: function ionViewWillEnter() {
            ...
            if (id != 0) {
              this.fetch.reviewFood(id).subscribe(function (res) {
                _this3.veg_food = res['data'];
              });
            }

            if (id2 != 0) {
              this.fetch.reviewFood(id2).subscribe(function (res) {
                _this3.nonveg_food = res['data'];
              });
            }
                  ...
                  case 3:
                    ...
                    modal.onDidDismiss().then(function (dataReturned) {
                      if (dataReturned !== null) {
                        ...
                        _this4.location_data = JSON.parse(_this4.dataReturned);
                        _this4.donate_address = _this4.dataReturned;
                        var formData = new FormData();
                        formData.append("id", _this4.model.veg);
                        formData.append("id2", _this4.model.nonveg);
                        formData.append("donate_address", _this4.donate_address);
                        var data = JSON.stringify({
                          'id': _this4.model.veg,
                          'id2': _this4.model.nonveg,
                          'donate_address': _this4.donate_address
                        });

                        _this4.fetch.donate_food_location_new(formData).subscribe(function (res) {
                          _this4.model.search = false;

                          _this4.openModalDonateFood();
                        });
                      }
                    });
                    _context3.next = 7;
              ...
              return _regeneratorRuntime().wrap(function _callee5$(_context5) {
                while (1) switch (_context5.prev = _context5.next) {
                  ...
                  case 2:
                    ...
                    modal.onDidDismiss().then(function (dataReturned) {
                      _this6.openModalCurrentLocation();
                    });
                    _context5.next = 6;
                    return modal.present();
