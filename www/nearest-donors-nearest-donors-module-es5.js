  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["nearest-donors-nearest-donors-module"], {
    ...
    function TnvT(module, __webpack_exports__, __webpack_require__) {
      ...
      var NearestDonorsPage = /*#__PURE__*/function () {
        ...
        return _createClass(NearestDonorsPage, [{
          key: "ngOnInit",
          value: function ngOnInit() {}
        }, {
          ...
          value: function ionViewWillEnter() {
            ...
            this.fetch.getKeyText(lang_code).subscribe(function (res) {
              ...
              _this3.model.key_text1 = item1[lang_code];
              var item2 = res.find(function (i) {
                return i.key_text === 'SORT';
              });
              _this3.model.key_text2 = item2[lang_code];
              var item3 = res.find(function (i) {
                return i.key_text === 'FILTER';
              });
              _this3.model.key_text3 = item3[lang_code];
              var item5 = res.find(function (i) {
                return i.key_text === 'COLLECT_FOOD';
              });
              _this3.model.key_text5 = item5[lang_code];
              var item6 = res.find(function (i) {
                return i.key_text === 'WALK';
              });
              _this3.model.key_text6 = item6[lang_code];
              var item7 = res.find(function (i) {
                return i.key_text === 'TWO-WHEELER';
              });
              _this3.model.key_text7 = item7[lang_code];
              var item8 = res.find(function (i) {
                return i.key_text === 'PUBLIC_TRANSPORT';
              });
              _this3.model.key_text8 = item8[lang_code];
              var item9 = res.find(function (i) {
                return i.key_text === 'HOME';
              });
              _this3.model.key_text9 = item9[lang_code];
              var item10 = res.find(function (i) {
                return i.key_text === 'ACTIVITY';
              });
              _this3.model.key_text10 = item10[lang_code];
              var item11 = res.find(function (i) {
                return i.key_text === 'VOLUNTEER';
              });
              _this3.model.key_text11 = item11[lang_code];
              var item12 = res.find(function (i) {
                return i.key_text === 'NO_DONOR';
              });
              _this3.model.key_text12 = item12[lang_code];
              var item13 = res.find(function (i) {
                return i.key_text === 'OKAY';
              });
              _this3.model.key_text13 = item13[lang_code];
            });
            var id = this.route.snapshot.params['id'];
            this.model.receiver_id = this.route.snapshot.params['id'];
            this.fetch.receiver_details(id).subscribe(function (res) {
              _this3.model.city = res['data'].city;
              _this3.model.colony_name = res['data'].colony_name;
              _this3.model.receiver_lat = res['data'].latitude;
              _this3.model.receiver_lon = res['data'].longitude;
              _this3.model.food_type = res['data'].food_type;
              _this3.model.no_of_person = res['data'].no_of_person;
              ...
              console.log(_this3.model.receiver_data);
                    ...
                    modal.onDidDismiss().then(function (dataReturned) {
                      if (dataReturned !== null) {
                        ...
                        if (_this4.dataReturned != "close") {
                          ...
                          _this4.model.food_type = _this4.dataReturned.filter_food_type;
                          _this4.model.no_of_person = _this4.dataReturned.filter_no_of_person;
                          _this4.model.receiver_data = JSON.stringify({
                            'latitude': _this4.model.receiver_lat,
                            'longitude': _this4.model.receiver_lon,
                            'city': _this4.model.city,
                            'food_type': _this4.model.food_type,
                            'needed_person': _this4.model.no_of_person,
                            'skip': 0
                          });

                          _this4.fetch.nearest_donors(_this4.model.receiver_data).subscribe(function (response) {
                            /* var self = this;
                            ...
                            $('#nearest_donors_list').css('display', 'block');
                            console.log(response['data']);
                            _this4.model.donor_data = response['data'];
                          });
                        }
                      }
                    });
                  ...
                  case 2:
                    ...
                    modal.onDidDismiss().then(function (dataReturned) {
                      if (dataReturned !== null) {
                        ...
                        console.log('Modal Sent Data :' + JSON.stringify(_this5.dataReturned));

                        if (_this5.dataReturned != "close") {
                          $('#nearest_donors_spinner').css('display', 'block');
                          $('#nearest_donors_list').css('display', 'none');

                          if (_this5.dataReturned.distance != null) {
                            //console.log(this.dataReturned.distance);
                            //this.model.donor_data.sort();
                            $('#nearest_donors_spinner').css('display', 'none');
                            $('#nearest_donors_list').css('display', 'block');

                            _this5.model.donor_data.sort(function (a, b) {
                            ...
                            console.log(_this5.model.donor_data);
                          }

                          if (_this5.dataReturned.time != null) {
                            $('#nearest_donors_spinner').css('display', 'none');
                            $('#nearest_donors_list').css('display', 'block');
          ...
          value: function loadData(event) {
            ...
            setTimeout(function () {
              ...
              self.model.receiver_data = JSON.stringify({
                ...
                'needed_person': _this6.model.no_of_person,
                'skip': j
              });
    ...
    function e9r2(module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_exports__["default"] = "#nearest_donors_list {\n  display: none;\n}\n\n.current_location_sppiner {\n  --color:#419B95;\n}\n\n.current_location_spinner_position {\n  margin-top: 250px;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
      /***/
    },
    ...
    /***/
    function qX_V(module, __webpack_exports__, __webpack_require__) {
      "use strict";
