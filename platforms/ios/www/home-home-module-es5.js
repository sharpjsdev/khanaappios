(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["home-home-module"], {
    ...
    function zpKS(module, __webpack_exports__, __webpack_require__) {
      ...
      var _ionic_native_browser_tab_ngx__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
      ...
      var HomePage = /*#__PURE__*/function () {
        function HomePage(modalController, router, storage, platform, geolocation, fetch, diagnostic, alertCtrl, browserTab) {
          var _this3 = this;
          ...
          this.platform.backButton.subscribeWithPriority(10, function () {
            _this3.router.navigate(['/home']); //navigator['app'].exitApp();
        ...
        _createClass(HomePage, [{
          ...
          value: function ngOnInit() {
            ...
            this.fetch.detectSlowNetwork().subscribe(function (res) {});
            var platform = '';
          ...
          value: function presentAlertAuth() {
