                  ...
                  case 3:
                    ...
                    modal.onDidDismiss().then(function (dataReturned) {
                      if (dataReturned !== null) {
                        ...
                        _this2.fetch.test(formData).subscribe(function (res) {
                          if (res['success'] == true) {
                            if (res['data'].length > 0) {
                              _this2.router.navigate(['/searching-volunteer', _this2.model.veg, _this2.model.nonveg]);
                            } else {
                              _this2.showAlert(_this2.model.key_text3);

                              _this2.router.navigate(['/screen-after-volunteer-not-found', _this2.model.veg, _this2.model.nonveg]);
                            }
                          }
                        });
                      }
