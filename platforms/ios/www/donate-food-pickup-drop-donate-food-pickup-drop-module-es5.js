          ...
          value: function ionViewWillEnter() {
            ...
            if (id != 0) {
              this.fetch.reviewFood(id).subscribe(function (res) {
                _this2.veg_food = res['data'];
              });
            }

            if (id2 != 0) {
              this.fetch.reviewFood(id2).subscribe(function (res) {
                _this2.nonveg_food = res['data'];
              });
            }
                    ...
                    modal.onDidDismiss().then(function (dataReturned) {
                      if (dataReturned !== null) {
                        ...
                        var data = JSON.stringify({
                          'id': _this3.model.veg,
                          'id2': _this3.model.nonveg,
                          'donate_address': _this3.donate_address
                        });

                        _this3.fetch.donate_food_location_new(formData).subscribe(function (res) {
                          _this3.model.search = false;

                          _this3.openModalDonateFood();
                        });
                      }
                    });
                    _context2.next = 7;
              ...
              return _regeneratorRuntime().wrap(function _callee4$(_context4) {
                while (1) switch (_context4.prev = _context4.next) {
                  ...
                  case 2:
                    ...
                    modal.onDidDismiss().then(function (dataReturned) {
                      _this5.openModalCurrentLocation();
                    });
                    _context4.next = 6;
                    return modal.present();
