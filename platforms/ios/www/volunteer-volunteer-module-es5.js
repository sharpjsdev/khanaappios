        ...
        _createClass(CaptchaComponent, [{
          ...
          value: function ngOnInit() {
            ...
            this.NotificationCount.data$.subscribe(function (newData) {
              _this9.notificationCount = newData;
            });
            ...
            this.fetch.get_notification(this.model.user_id).subscribe(function (res) {
              _this9.notification = res['data'];
              _this9.notifications_admin = res['notifications'];

              if (_this9.notification.length != 0 || _this9.notifications_admin.length != 0) {
                $('#black_spot').show();
                var notifCount = _this9.notification.length + _this9.notifications_admin.length;

                _this9.NotificationCount.updateData(notifCount);
              }
            });
          }
        }, {
